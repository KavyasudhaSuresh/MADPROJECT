...
import com.rajkishorbgp.quizapplication.databinding.ActivityClanguageBinding


class C_Language_Activity : AppCompatActivity() {
    private lateinit var binding: ActivityClanguageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityClanguageBinding.inflate(layoutInflater)
